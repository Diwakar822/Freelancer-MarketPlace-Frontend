...
const API_URL = "https://freelancer-marketplace-backend-1.onrender.com/api/contract"; // Replace with your actual backend URL
const AddContract = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch('https://freelancer-marketplace-backend-1.onrender.com/api/contract', {
          method: "POST",
