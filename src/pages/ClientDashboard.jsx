    ...
    return (
      ...
      <section className="client-dashboard-content">
        ...
        <div className="client-dashboard-card">
          ...
          <div className="card-action">
           <Link to={'/freelancer/:freelancerId'}><button className="action-button">Create Reviews</button></Link>
          </div>
        </div>
        <div className="client-dashboard-card">
          <h3>Payments</h3>
          ...
          <p>Pending: $1,200</p>
          <div className="card-action">
            <Link to={'/checkout'}><button className="action-button">Make Payments</button></Link>
          </div>
        </div>
        <div className="client-dashboard-card">
          <h3>Services</h3>
